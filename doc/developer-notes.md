...
Xrev Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9090.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9091 for connections and services them.
...
However, in open source software such as Xrev Core, where everyone uses
...
pay attention to for reviewers of Xrev Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Xrev Core uses tinyformat, which is type safe. Leave them out to avoid confusion
