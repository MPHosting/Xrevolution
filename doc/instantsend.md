...
This mechanism has been integrated into Bitcore-Node-Xrev which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xrevpay/insight-api-xrev#web-socket-api](https://github.com/xrevpay/insight-api-xrev#web-socket-api) 
* API: [https://github.com/xrevpay/insight-api-xrev#instantsend-transactions](https://github.com/xrevpay/insight-api-xrev#instantsend-transactions) 
...
By default, the Xrev Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Xrev Core daemon:
