...
Only requiring some minor changes is xrev.cpp.
...
Changes to xrev.cpp
----------------------
xrev.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
