 ...
 *
 *   // network
 *   CXrevNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.xrev.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CXrevNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: XrevNetwork
// //   -- signature requirements : Key1(User)
// class CXrevNetworkVariable : public CGovernanceObject
// {
// private:
