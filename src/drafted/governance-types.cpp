...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "XrevNetwork") type = XrevNetwork;
    if(strType == "XrevNetworkVariable") type = XrevNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == XrevNetwork) s = "XrevNetwork";
    if(type == XrevNetworkVariable) s = "XrevNetworkVariable";
