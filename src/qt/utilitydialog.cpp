    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Xrev Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Xrev Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  xrev-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Xrev in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XREV, 0.1 XREV, 1 XREV and 10 XREV -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://xrevpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://xrevpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Xrev Core is shutting down...") + "<br /><br />" +
