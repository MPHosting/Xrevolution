    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Xrev Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xrev address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xrev: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Xrev Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xrev Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xrev Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xrev addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xrev addresses"));
    ...
    openAction->setStatusTip(tr("Open a xrev: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xrev Core help message to get a list with possible Xrev Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Xrev Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xrev network", "", count));
}
...
{
    QString strTitle = tr("Xrev Core"); // default title
