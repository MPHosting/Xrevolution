    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XREV-light"), QVariant("light"));
    ui->theme->addItem(QString("XREV-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XREV-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XREV-traditional"), QVariant("trad"));
